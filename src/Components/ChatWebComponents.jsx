...
const ChatWebComponents = () => {
  return (
    <div className="min-h-screen bg-gray-100 flex">
      {/* Sidebar (People List) */}
      <aside className="bg-white w-80 border-r border-gray-200 p-4 flex flex-col">
        {/* Chat Search */}
        ...
        {/* Add New Chat Button */}
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md mb-4 flex items-center justify-center">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start space-x-2 max-w-md">
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Image sent</p>
              </div>
            </div>
            {/* File Upload Message */}
            <div className="flex items-end space-x-2 justify-end max-w-xs self-end">
